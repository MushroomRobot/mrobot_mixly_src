...
export const display_show_image = function (block, generator) {
...
export const display_show_image_or_string_delay = function (block, generator) {
    var version = Mixly.Boards.getSelectedBoardKey().split(':')[2]
    var data = generator.valueToCode(this, 'data', generator.ORDER_ASSIGNMENT);
...
export const display_show_frame_string = function (block, generator) {
    var version = Mixly.Boards.getSelectedBoardKey().split(':')[2]
    if (version == 'mpython') {
...
export const display_show_frame_string_delay = function (block, generator) {
    var version = Mixly.Boards.getSelectedBoardKey().split(':')[2]
    generator.definitions_['import_' + version + '_onboard_matrix'] = "from " + version + " import onboard_matrix";
    var data = generator.valueToCode(this, 'data', generator.ORDER_ASSIGNMENT);
...
export const display_scroll_string = function (block, generator) {
    var version = Mixly.Boards.getSelectedBoardKey().split(':')[2]
    if (version == 'mpython') {
        generator.definitions_['import_' + version + '_onboard_oled'] = "from " + version + " import onboard_oled";
        var data = generator.valueToCode(this, 'data', generator.ORDER_ASSIGNMENT);
...
export const display_scroll_string_delay = function (block, generator) {
    var version = Mixly.Boards.getSelectedBoardKey().split(':')[2]
    generator.definitions_['import_' + version + '_onboard_matrix'] = "from " + version + " import onboard_matrix";
    var data = generator.valueToCode(this, 'data', generator.ORDER_ASSIGNMENT);
    var time = generator.valueToCode(this, 'time', generator.ORDER_ASSIGNMENT);
...
export const display_bright_point = function (block, generator) {
    var version = Mixly.Boards.getSelectedBoardKey().split(':')[2]
    generator.definitions_['import_' + version + '_onboard_matrix'] = "from " + version + " import onboard_matrix";
...
export const display_get_screen_pixel = function (block, generator) {
    var version = Mixly.Boards.getSelectedBoardKey().split(':')[2]
    generator.definitions_['import_' + version + '_onboard_matrix'] = "from " + version + " import onboard_matrix";
...
export const display_bright_screen = function (block, generator) {
    var version = Mixly.Boards.getSelectedBoardKey().split(':')[2]
    generator.definitions_['import_' + version + '_onboard_matrix'] = "from " + version + " import onboard_matrix";
    var x = generator.valueToCode(this, 'x', generator.ORDER_ASSIGNMENT);
...
export const onboard_oled_show_image = function (block, generator) {
    var version = Mixly.Boards.getSelectedBoardKey().split(':')[2]
    generator.definitions_['import_' + version + '_onboard_oled'] = "from " + version + " import onboard_oled";
    var data = generator.valueToCode(this, 'data', generator.ORDER_ASSIGNMENT);
...
export const onboard_oled_show_image_xy = function (block, generator) {
    var version = Mixly.Boards.getSelectedBoardKey().split(':')[2]
    generator.definitions_['import_' + version + '_onboard_oled'] = "from " + version + " import onboard_oled";
    var data = generator.valueToCode(this, 'data', generator.ORDER_ASSIGNMENT);
    var x = generator.valueToCode(this, 'x', generator.ORDER_ASSIGNMENT);
...
export const onboard_oled_show_string = function (block, generator) {
    var version = Mixly.Boards.getSelectedBoardKey().split(':')[2]
    generator.definitions_['import_' + version + '_onboard_oled'] = "from " + version + " import onboard_oled";
    var data = generator.valueToCode(this, 'data', generator.ORDER_ASSIGNMENT);
...
export const onboard_oled_show_image_or_string_delay = function (block, generator) {
    var version = Mixly.Boards.getSelectedBoardKey().split(':')[2]
    generator.definitions_['import_' + version + '_onboard_oled'] = "from " + version + " import onboard_oled";
    var data = generator.valueToCode(this, 'data', generator.ORDER_ASSIGNMENT);
    var x = generator.valueToCode(this, 'x', generator.ORDER_ASSIGNMENT);
...
export const onboard_oled_show_frame_string_delay = function (block, generator) {
    var version = Mixly.Boards.getSelectedBoardKey().split(':')[2]
    generator.definitions_['import_' + version + '_onboard_oled'] = "from " + version + " import onboard_oled";
    var data = generator.valueToCode(this, 'data', generator.ORDER_ASSIGNMENT);
    var size = generator.valueToCode(this, 'size', generator.ORDER_ASSIGNMENT);
...
export const onboard_oled_scroll_string_delay = function (block, generator) {
    var version = Mixly.Boards.getSelectedBoardKey().split(':')[2]
    generator.definitions_['import_' + version + '_onboard_oled'] = "from " + version + " import onboard_oled";
    var data = generator.valueToCode(this, 'data', generator.ORDER_ASSIGNMENT);
    var y = generator.valueToCode(this, 'y', generator.ORDER_ASSIGNMENT);
...
export const onboard_oled_bright_point = function (block, generator) {
    var version = Mixly.Boards.getSelectedBoardKey().split(':')[2]
    generator.definitions_['import_' + version + '_onboard_oled'] = "from " + version + " import onboard_oled";
    var x = generator.valueToCode(this, 'x', generator.ORDER_ASSIGNMENT);
    var y = generator.valueToCode(this, 'y', generator.ORDER_ASSIGNMENT);
...
export const mixbot_display_get_screen_pixel = function (block, generator) {
    var version = Mixly.Boards.getSelectedBoardKey().split(':')[2]
    generator.definitions_['import_' + version + '_onboard_matrix'] = "from " + version + " import onboard_matrix";
...
export const mixbot_display_get_ambientbright = function (block, generator) {
    var version = Mixly.Boards.getSelectedBoardKey().split(':')[2]
    generator.definitions_['import_' + version + '_onboard_matrix'] = "from " + version + " import onboard_matrix";
...
export const mixbot_display_bright_screen = function (block, generator) {
    var version = Mixly.Boards.getSelectedBoardKey().split(':')[2]
    generator.definitions_['import_' + version + '_onboard_matrix'] = "from " + version + " import onboard_matrix";
    var x = generator.valueToCode(this, 'x', generator.ORDER_ASSIGNMENT);
...
export const onboard_tft_show_image = function (block, generator) {
    var version = Mixly.Boards.getSelectedBoardKey().split(':')[2]
    generator.definitions_['import_' + version + '_onboard_tft'] = "from " + version + " import onboard_tft";
    var data = generator.valueToCode(this, 'data', generator.ORDER_ASSIGNMENT);
...
export const onboard_tft_show_image_xy = function (block, generator) {
    var version = Mixly.Boards.getSelectedBoardKey().split(':')[2]
    generator.definitions_['import_' + version + '_onboard_tft'] = "from " + version + " import onboard_tft";
    var data = generator.valueToCode(this, 'data', generator.ORDER_ASSIGNMENT);
    var x = generator.valueToCode(this, 'x', generator.ORDER_ASSIGNMENT);
...
export const onboard_tft_show_image_or_string_delay = function (block, generator) {
    var version = Mixly.Boards.getSelectedBoardKey().split(':')[2]
    generator.definitions_['import_' + version + '_onboard_tft'] = "from " + version + " import onboard_tft";
    var data = generator.valueToCode(this, 'data', generator.ORDER_ASSIGNMENT);
    var x = generator.valueToCode(this, 'x', generator.ORDER_ASSIGNMENT);
...
export const onboard_tft_show_frame_string = function (block, generator) {
    var version = Mixly.Boards.getSelectedBoardKey().split(':')[2]
...
export const onboard_tft_show_frame_string_delay = function (block, generator) {
    var version = Mixly.Boards.getSelectedBoardKey().split(':')[2]
    generator.definitions_['import_' + version + '_onboard_tft'] = "from " + version + " import onboard_tft";
    var data = generator.valueToCode(this, 'data', generator.ORDER_ASSIGNMENT);
    var size = generator.valueToCode(this, 'size', generator.ORDER_ASSIGNMENT);
...
export const onboard_tft_scroll_string = function (block, generator) {
    var version = Mixly.Boards.getSelectedBoardKey().split(':')[2]
    generator.definitions_['import_' + version + '_onboard_oled'] = "from " + version + " import onboard_tft";
    var data = generator.valueToCode(this, 'data', generator.ORDER_ASSIGNMENT);
...
export const onboard_tft_scroll_string_delay = function (block, generator) {
    var version = Mixly.Boards.getSelectedBoardKey().split(':')[2]
    generator.definitions_['import_' + version + '_onboard_tft'] = "from " + version + " import onboard_tft";
    var data = generator.valueToCode(this, 'data', generator.ORDER_ASSIGNMENT);
    var y = generator.valueToCode(this, 'y', generator.ORDER_ASSIGNMENT);
...
export const onboard_tft_bright_point = function (block, generator) {
    var version = Mixly.Boards.getSelectedBoardKey().split(':')[2]
    generator.definitions_['import_' + version + '_onboard_tft'] = "from " + version + " import onboard_tft";
    var x = generator.valueToCode(this, 'x', generator.ORDER_ASSIGNMENT);
    var y = generator.valueToCode(this, 'y', generator.ORDER_ASSIGNMENT);
...
export const onboard_tft_get_screen_pixel = function (block, generator) {
    var version = Mixly.Boards.getSelectedBoardKey().split(':')[2]
    generator.definitions_['import_' + version + '_onboard_tft'] = "from " + version + " import onboard_tft";
...
export const onboard_tft_bright_screen = function (block, generator) {
    var version = Mixly.Boards.getSelectedBoardKey().split(':')[2]
    generator.definitions_['import_' + version + '_onboard_tft'] = "from " + version + " import onboard_tft";
    var x = generator.valueToCode(this, 'x', generator.ORDER_ASSIGNMENT);
...
export const onboard_tft_fill = function (block, generator) {
    var version = Mixly.Boards.getSelectedBoardKey().split(':')[2]
    generator.definitions_['import_' + version + '_onboard_tft'] = "from " + version + " import onboard_tft";
...
export const onboard_tft_clock_init = function (block, generator) {
    var version = Mixly.Boards.getSelectedBoardKey().split(':')[2]
...
export const onboard_tft_clock_get_rtctime = function (block, generator) {
    var version = Mixly.Boards.getSelectedBoardKey().split(':')[2]
    generator.definitions_['import_' + version + '_Clock'] = "from " + version + " import Clock";
    var sub = generator.valueToCode(this, 'SUB', generator.ORDER_ASSIGNMENT);
...
export const onboard_tft_clock_set_time = function (block, generator) {
    var version = Mixly.Boards.getSelectedBoardKey().split(':')[2]
    generator.definitions_['import_' + version + '_Clock'] = "from " + version + " import Clock";
    var sub = generator.valueToCode(this, 'SUB', generator.ORDER_ASSIGNMENT);
...
export const onboard_tft_clock_draw = function (block, generator) {
    var version = Mixly.Boards.getSelectedBoardKey().split(':')[2]
    generator.definitions_['import_' + version + '_Clock'] = "from " + version + " import Clock";
    var sub = generator.valueToCode(this, 'SUB', generator.ORDER_ASSIGNMENT);
...
export const onboard_tft_clock_clear = function (block, generator) {
    var version = Mixly.Boards.getSelectedBoardKey().split(':')[2]
    generator.definitions_['import_' + version + '_Clock'] = "from " + version + " import Clock";
    var sub = generator.valueToCode(this, 'SUB', generator.ORDER_ASSIGNMENT);
    var color = generator.valueToCode(this, 'VAR', generator.ORDER_ATOMIC);
