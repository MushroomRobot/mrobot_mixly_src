...
const FIELD_COLOUR_CONFIG1 = {
    colourOptions: ['#f00', '#000'],
    columns: 2
};

const FIELD_COLOUR_CONFIG2 = {
    colourOptions: [
        // grays
...
export const display_rgb_color = {
    init: function () {
        ...
        this.appendDummyInput("")
            ...
            .appendField(new Blockly.FieldColour('#ff0000', null, FIELD_COLOUR_CONFIG2), 'FIELDNAME');
        this.setInputsInline(true);
        this.setPreviousStatement(true, null);
        this.setNextStatement(true, null);
        this.setTooltip('');
...
export const display_color_seclet = {
    init: function () {
        this.setColour(DISPLAY_EXTERN_HUE);
        let fieldColorObj = new Blockly.FieldColour('#f00', null, FIELD_COLOUR_CONFIG1);
        this.appendDummyInput("")
            .setAlign(Blockly.inputs.Align.RIGHT)
